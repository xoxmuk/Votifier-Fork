...
import ru.xoxmuk.votifierfork.config.Config;
...
import ru.xoxmuk.votifierfork.model.VotifierEvent;
...
public class VotifierFork extends JavaPlugin {

	private static VotifierFork instance;
	...
	public void onEnable() {
		...
		getCommand("VotifierFork").setExecutor(new CommandVotifierFork(this));
		getCommand("VotifierFork").setTabCompleter(new VotifierForkTabCompleter());
	...
	public static VotifierFork getInstance() {
		return instance;
	}

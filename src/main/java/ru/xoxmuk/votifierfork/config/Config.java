package ru.xoxmuk.votifierfork.config;
...
public class Config extends YMLFile {
	...
	public Config(VotifierFork plugin) {
		super(plugin, new File(VotifierFork.getInstance().getDataFolder(), "config.yml"));
	}
	...
	public void onFileCreation() {
		VotifierFork.getInstance().saveResource("config.yml", true);
	}
